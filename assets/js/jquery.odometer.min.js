...
=============================================*/
  $(".cart-plus-minus").append(
    '<div class="dec qtybutton"><span>-</span></div><div class="inc qtybutton"><span>+</span></div>'
  );
...
=============================================*/
  $("[data-countdown]").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<div class="time-count day"><span>%D</span><strong>d</strong> </div><div class="time-count hour"><span>%H</span><strong>h</strong></div><div class="time-count min"><span>%M</span><strong>m</strong></div><div class="time-count sec"><span>%S</span><strong>s</strong></div>'
        )
      );
    });
  });
