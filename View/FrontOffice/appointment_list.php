...
<div class="list-appointments-container">
        ...
        <div class="appointments-wrapper">
            ...
            <div class="appointment-card">
                ...
                <div class="appointment-header">
                    <span class="appt-date"><?= htmlspecialchars($a['appointment_date']) ?></span>
                    <span class="appt-time"><?= htmlspecialchars($a['start_time'] . ' - ' . $a['end_time']) ?></span>
                </div>

                <div class="appointment-details">
                    <div><strong>Species:</strong> <?= htmlspecialchars($a['species']) ?></div>
                    <div><strong>Reason:</strong> <?= htmlspecialchars($a['visit_reason']) ?></div>
                    <div><strong>Status:</strong> <?= htmlspecialchars(ucfirst($a['status'])) ?></div>
                    <div><strong>Emergency:</strong> <?= $a['is_emergency'] ? 'Yes' : 'No' ?></div>
                    <div><strong>First visit:</strong> <?= $a['first_visit'] ? 'Yes' : 'No' ?></div>
                </div>

                <div class="appointment-actions">
                    <a href="appointmentcontroller.php?action=edit&id=<?= $a['appointment_id'] ?>" class="btn-edit">Edit</a>
                    <a href="appointmentcontroller.php?action=delete&id=<?= $a['appointment_id'] ?>"
    ...
    <?php else: ?>
        <div class="appointments-empty">You have no appointments yet!!</div>
    <?php endif; ?>

    <a href="/petty/View/FrontOffice/reservation.php" class="appointments-back-btn">← Book another appointment</a>
